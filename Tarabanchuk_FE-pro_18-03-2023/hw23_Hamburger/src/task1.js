...
// 	console.log("Is hamburger large: ", hamburger.getSize() === Hamburger.SIZE_LARGE); // -> false isSize
...
class Hamburger {
  ...
  static #TOPPING_SPICE = new CompositionElement(10, 0);
  ...
  static get TOPPING_SPICE () { return Hamburger.#TOPPING_SPICE};
  static get TOPPING_MAYO () { return Hamburger.#TOPPING_MAYO};

  #size = null;       //@param {String} size - Размер #unicum value for class
  #stuff = null;      //* @param {String} stuffing - Начинка
  #ingredients = [];
...
console.log('Calories: ' + hamburger.calculate ());   //65

// тут я передумал и решил добавить еще приправу
hamburger.addTopping(Hamburger .TOPPING_SAUCE);

// Сколько теперь стоит?
console.log('Price with sauce:' + hamburger.calculatePrice()); //145